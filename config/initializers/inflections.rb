...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular 'tipo_actor', 'tipo_actores'
  inflect.irregular 'tipo_concepto', 'tipo_conceptos'
  inflect.irregular 'caso_estado', 'caso_estados'
  inflect.irregular 'tipo_proceso', 'tipo_procesos'
  inflect.irregular 'caso_actor', 'caso_actores'
